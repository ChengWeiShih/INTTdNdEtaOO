...
void InttDoubletMap_template(TString inputPath = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/CarryOverHit/82420/InttDoublets/FPHX_range_10/completed/Data_INTTDoublets_StreamTrig_FphxBcoRange106to116_VtxZRangeN15to15_ClusQAAdc0PhiSize128_DeltaPhiCut0p150_00082420_merged.root")
{
    // =====================================================================
    // Input / Output setup
    // =====================================================================
    ...
    std::pair<double, double> DeltaPhi_cut = {
        -1 * PassParams::DeltaPhiCut,
        PassParams::DeltaPhiCut
    };
