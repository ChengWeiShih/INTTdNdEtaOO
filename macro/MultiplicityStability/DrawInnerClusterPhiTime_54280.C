...
void DrawInnerClusterPhiTime_54280(
    const std::string input_dir =
        "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/seflgendata/run_54280_HR_Feb102025/Run6_EvtZFitWidthChange/EvtInterval/completed",
    const std::string output_file = "InnerClusterPhiTime_00054280.root",
    const int file_first = 0,
    const int file_last = 999,
    const double bco_period_ns = 106.0)
{
    const std::string file_prefix =
        "Data_EvtVtxZProtoTracklet_FieldOff_BcoFullDiff_00054280_";
