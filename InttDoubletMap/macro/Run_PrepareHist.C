...
void Run_PrepareHist(
  ...
  int run_num = -1,
  int nevents = -1,
  string input_directory = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/MC/20260215/HIJING_INTTSurveyOnly_CentralityScaleTest/EvtVtxZ/completed",
  string input_filename = "MC_EvtVtxZProtoTracklet_FieldOn_VtxZReco_00000.root",
  string output_directory = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/MC/20260215/HIJING_INTTSurveyOnly_CentralityScaleTest/InttDoubletMap",
  
  // todo : modify here
  std::string output_file_name_suffix = "",
  std::pair<double, double> vertexXYIncm = {-0.0059375, -0.0025},

  std::pair<bool, TH1D*> vtxZReweight = {false, nullptr},
  bool BcoFullDiffCut = true,
  bool INTT_vtxZ_QA = false, // todo: no vtxZ QA
