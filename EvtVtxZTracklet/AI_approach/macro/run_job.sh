...
root.exe -q -b Run_EvtVtxZProtoTracklet_MultiVtx_MC.C\(${process},${runnumber},${nEvents},\"${input_directory}\",\"${input_filename}\",\"${output_directory}\"\)


echo all done process the Run_EvtVtxZProtoTracklet_MultiVtx_MC.C, process_id ${process}
