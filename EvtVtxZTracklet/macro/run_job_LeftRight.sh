...
root.exe -q -b Run_EvtVtxZLeftRight.C\(${process},${runnumber},${nEvents},\"${input_directory}\",\"${input_filename}\",\"${output_directory}\"\)


echo all done process the Run_EvtVtxZLeftRight.C, process_id ${process}
