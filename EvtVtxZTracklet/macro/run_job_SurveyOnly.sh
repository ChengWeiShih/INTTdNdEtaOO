...
root.exe -q -b Run_EvtVtxZTracklet_SurveyOnly.C\(${process},${runnumber},${nEvents},\"${input_directory}\",\"${input_filename}\",\"${output_directory}\"\)


echo all done process the Run_EvtVtxZTracklet_SurveyOnly.C, process_id ${process}
