...
void Fun4All_Intt_HitMap_81000(
  int process_id = 0,
  int run_num = 82391,
  int nevents = -1,
  ...
  // todo : modify here
  string hot_channel_full_file_directory = "/cvmfs/sphenix.sdcc.bnl.gov/calibrations/sphnxpro/cdb/INTT_HotMap/d4/a0/d4a0ddc029d22d3dc3ae8f7af0cff247_intt_hotmap_cdb_00081000.root",
...
)
{
  ...
  for (int i = 0; i < 8; i++)
  {
      ...
      std::string intt_folder_direcotry = Form("DST_STREAMING_EVENT_intt%d/run_00081000_00081100", i);
      std::string intt_file_name = Form("DST_STREAMING_EVENT_intt%d_run3pp_ana532_nocdbtag_v001-000%d-%s.root", i, run_num, job_index.c_str());
