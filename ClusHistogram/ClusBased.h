...
class ClusBased {
    public:
        ...
        void SetGoodColMap(TH2D * input_h2D_GoodColMap) {h2D_GoodColMap = input_h2D_GoodColMap;}
    ...
    protected:
        ...
        std::map<std::string, std::tuple<double, double, double, int, int, int, int, int>> inner_UniqueClusXYZ_map;
        std::map<std::string, std::tuple<double, double, double, int, int, int, int, int>> outer_UniqueClusXYZ_map;
        ...
        TH1D * h1D_GoodColMap_ZId = nullptr;
        ...
        double VtxZEdge_min = -10;
        double VtxZEdge_max = 10;
        int nVtxZBin = 1;
        int nVtxZBin_FineBin = 500;

        std::vector<int> typeA_sensorZID = {0,2};
