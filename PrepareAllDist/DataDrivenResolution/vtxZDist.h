...
class vtxZDist{
    public:
        vtxZDist(
            ...
            std::pair<bool, int> ApplyEvtBcoFullDiffCut_in = {true, 80},
            bool isMBDAsymmCut_in = true,
            bool CheckDataDrivenVtxZResolution_in = false
        );
    ...
    protected:
        ...
        bool isMBDAsymmCut;
        bool CheckDataDrivenVtxZResolution;
        ...
        double Left_INTTvtxZ;
        double Left_INTTvtxZError;
        double Left_NgroupTrapezoidal;
        double Left_NgroupCoarse;
        double Left_TrapezoidalFitWidth;
        double Left_TrapezoidalFWHM;

        double Right_INTTvtxZ;
        double Right_INTTvtxZError;
        double Right_NgroupTrapezoidal;
        double Right_NgroupCoarse;
        double Right_TrapezoidalFitWidth;
        double Right_TrapezoidalFWHM;
        ...
        TF1 * f1_MBDAsymmCut1 = nullptr;
        TF1 * f1_MBDAsymmCut2 = nullptr;
        // std::pair<double, double> MBDAsymmCutSlope1_pair = Constants::MBDAsymmCutSlope1_pair;
        // std::pair<double, double> MBDAsymmCutSlope2_pair = Constants::MBDAsymmCutSlope2_pair;    
