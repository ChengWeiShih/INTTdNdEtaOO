...
void vtxZDist::PrepareHist()
{
    ...
    h1D_map.insert(
        std::make_pair(
            "h1D_MBDz",
            new TH1D("h1D_MBDz","h1D_MBDz;MBD z-vertex [cm];Entries", 180,-90,90)
        )
    );
    ...
    h1D_map.insert(
        std::make_pair(
            "h1D_MBD_centrality",
            new TH1D("h1D_MBD_centrality","h1D_MBD_centrality;Centrality [%];Entries", 101,-0.5,100.5)
        )
    );
    ...
    h1D_map.insert(
        std::make_pair(
            "h1D_MBD_charge_sum",
            new TH1D("h1D_MBD_charge_sum","h1D_MBD_charge_sum;MBD charge sum;Entries", 200,0,1000)
        )
    );
    ...
    if (runnumber == -1){
        ...
        std::make_pair(
            "h1D_MBDz_resolution",
            new TH1D("h1D_MBDz_resolution","h1D_MBDz_resolution;z-vertex diff. (MBD - truth) [cm];Entries", 200,-10,10)
        )
    );
    }
    ...
    if (runnumber == -1)
    {
        h1D_map.insert(
            std::make_pair(
                ...
                new TH1D("h1D_INTTvtxZ_resolution_Inclusive100", "h1D_INTTvtxZ_resolution_Inclusive100;INTTvtxZ - Truth_{z} [cm];Entries (/0.1)",100, -10,10)
            )
        );
        h1D_map.insert(
            std::make_pair(
                "h1D_INTTvtxZ_resolution_Inclusive70", 
                new TH1D("h1D_INTTvtxZ_resolution_Inclusive70", "h1D_INTTvtxZ_resolution_Inclusive70;INTTvtxZ - Truth_{z} [cm];Entries (/0.1)",100, -10,10)
            )
        );
        h1D_map.insert(
            std::make_pair(
                "h1D_INTTvtxZ_resolution_HighNClus", 
            new TH1D("h1D_INTTvtxZ_resolution_HighNClus", "h1D_INTTvtxZ_resolution_HighNClus;INTTvtxZ - Truth_{z} [cm];Entries (/0.1)",100, -10, 10)
        )
        );
    }
    ...
    h2D_map.insert(
        std::make_pair(
            "h2D_NClus_INTTvtxZ",
            new TH2D("h2D_NClus_INTTvtxZ","h2D_NClus_INTTvtxZ;NClus (INTT);INTT vtxZ [cm]",200, 0, 2500, 200, vtxZ_range.first, vtxZ_range.second)
        )
    );
    ...
    h2D_map.insert(
        std::make_pair(
            ...
            new TH2D("h2D_NClus_TrapezoidalFitWidth","h2D_NClus_TrapezoidalFitWidth;NClus;INTT vtxZ Dist Fit Width [cm]", 100, 0, 2500, 100, 0, 15)
        )
    );
    ...
    h2D_map.insert(
        std::make_pair(
            ...
            new TH2D("h2D_NClus_TrapezoidalFWHM","h2D_NClus_TrapezoidalFWHM;NClus;INTT vtxZ Dist FWHM [cm]", 100, 0, 2500, 100, 0, 15)
        )
    );
    ...
    h2D_map.insert(
        std::make_pair(
            ...
            new TH2D("h2D_NClus_INTTvtxZError","h2D_NClus_INTTvtxZError;NClus;INTT vtxZ StdDev [cm]", 100, 0, 2500, 100, 0, 15)
        )
    );
    ...
    h2D_map.insert(
        std::make_pair(
            ...
            new TH2D("h2D_confirm_InttInnerOuterNClus","h2D_confirm_InttInnerOuterNClus;NClus (inner);NClus (outer)", 200, 0, 2000, 200, 0, 2000)
        )
    );
    ...
    if (runnumber == -1)
    {
        h2D_map.insert(
            std::make_pair(
                ...
                new TH2D("h2D_NClus_Zresolution","h2D_NClus_Zresolution;NClus;INTTvtxZ - Truth_{z} [cm]",100,0,2500,200,-10,10)
            )
        );
        ...
        h2D_map.insert(
            std::make_pair(
                ...
                new TH2D("h2D_truthZ_Zresolution_Inclusive100","h2D_truthZ_Zresolution_Inclusive100;Truth_{z} [cm];INTTvtxZ - Truth_{z} [cm]",100,-50,50,200,-10,10)
            )
        );
        ...
        h2D_map.insert(
            std::make_pair(
                ...
                new TH2D("h2D_truthZ_Zresolution_HighNClus","h2D_truthZ_Zresolution_HighNClus;Truth_{z} [cm];INTTvtxZ - Truth_{z} [cm]",100,-50,50,200,-10,10)
            )
        );
...
void vtxZDist::PrepareEvent()
{
    for (int i = 0; i < run_nEvents; i++)
    {
        ...
        h1D_map["h1D_MBDz"] -> Fill(MBD_z_vtx);
        h1D_map["h1D_MBD_centrality"] -> Fill(MBD_centrality);
        h1D_map["h1D_MBD_charge_sum"] -> Fill(MBD_charge_sum);
        if (runnumber == -1){h1D_map["h1D_MBDz_resolution"] -> Fill(MBD_z_vtx - TruthPV_trig_z);}
