...
class RestDist{
    ...
    protected:
        ...
        // Division : for the best pair quick check
        std::vector<pair_str> temp_all_pair_vec;
        std::vector<double> temp_all_pair_deltaR_vec;
        std::vector<double> temp_all_pair_DeltaPhi_vec;
        std::map<int, TH2D*> BestPair_h2D_map;
        std::map<int, TGraph*> BestPair_gr_map;

        TH1D * h1D_BestPair_DeltaEta;
        TH1D * h1D_BestPair_DeltaPhi;

        TH1D * h1D_BestPair_ClusEta_inner;
        TH1D * h1D_BestPair_ClusEta_outer;

        TH1D * h1D_BestPair_ClusAdc_inner;
        TH1D * h1D_BestPair_ClusAdc_outer;
        TH1D * h1D_BestPair_ClusAdc;
        
        TH1D * h1D_BestPair_ClusPhiSize_inner;
        TH1D * h1D_BestPair_ClusPhiSize_outer;
        TH1D * h1D_BestPair_ClusPhiSize;
        
        TH2D * h2D_BestPair_ClusAdcClusPhiSize_inner;
        TH2D * h2D_BestPair_ClusAdcClusPhiSize_outer;
        TH2D * h2D_BestPair_ClusAdcClusPhiSize;

        TH2D * h2D_BestPair_NClusClusAdc;
        TH2D * h2D_BestPair_NClusClusPhiSize;

        TH2D * h2D_BestPair_ClusZClusAdc_inner;
        TH2D * h2D_BestPair_ClusZClusAdc_outer;
        TH2D * h2D_BestPair_ClusZClusAdc;

        TH2D * h2D_BestPair_ClusZClusPhiSize_inner;
        TH2D * h2D_BestPair_ClusZClusPhiSize_outer;
        TH2D * h2D_BestPair_ClusZClusPhiSize;

        
        TH1D * h1D_BestPair_Vertical_ClusAdc_inner;
        TH1D * h1D_BestPair_Vertical_ClusAdc_outer;
        TH1D * h1D_BestPair_Vertical_ClusAdc;
        
        TH1D * h1D_BestPair_Vertical_ClusPhiSize_inner;
        TH1D * h1D_BestPair_Vertical_ClusPhiSize_outer;
        TH1D * h1D_BestPair_Vertical_ClusPhiSize;
        ...
        // note : for deta_phi
        double DeltaPhiEdge_min = -0.25; // note : rad ~ -4 degree
        double DeltaPhiEdge_max = 0.25;  // note : rad ~ 4 degree
        ...
        std::vector<double> data_edep_bins_vec = {
            0, 30, 35, 45, 80, 115, 150, 185, 215, 300
