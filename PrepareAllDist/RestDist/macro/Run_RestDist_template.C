...
void Run_RestDist_MC(
  ...
  std::pair<double, double> vertexXYIncm = {-0.0218978, 0.223183}, 
...
)
{
  ...
  TH1D * h1D_INTT_vtxZ_reweighting = (run_num == -1 && ApplyVtxZReWeighting) ? GetReweighting_hist(vtxZReWeighting_input_directory, map_name) : nullptr;
  ...
  if (ApplyVtxZReWeighting) {RDs1->SetINTTvtxZReweighting(h1D_INTT_vtxZ_reweighting);}
  ...
  if (ApplyVtxZReWeighting) {RDs2->SetINTTvtxZReweighting(h1D_INTT_vtxZ_reweighting);}
  ...
  if (ApplyVtxZReWeighting) {RDs3->SetINTTvtxZReweighting(h1D_INTT_vtxZ_reweighting);}
  ...
  if (ApplyVtxZReWeighting) {RDs4->SetINTTvtxZReweighting(h1D_INTT_vtxZ_reweighting);}
