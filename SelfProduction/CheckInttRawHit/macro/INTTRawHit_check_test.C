...
int INTTRawHit_check_test(
    ...
    int run_num = 54694,
    int nevents = 1000,
    string output_directory = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run24AuAu_DACScan/54694_test",
  
    // note : for macro
    string input_directory = "/sphenix/user/ChengWei/SelfINTTProduction/2025_Oct_20/jaein_decode_calib/completed_map_DACScan",
    string input_filename = "test_DST_beam_intt-00054694_special.root",
