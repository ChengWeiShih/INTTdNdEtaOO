...
# export MYINSTALL=/sphenix/user/ChengWei/SelfINTTProduction/2025_Oct_20/CheckInttRawHit/build/install
# export MYINSTALL2=/sphenix/user/ChengWei/SelfINTTProduction/2025_Oct_20/dNdEta_Run2023/dNdEtaINTT/build/install
...
export MYINSTALL=/sphenix/user/ChengWei/SelfINTTProduction/2025_Oct_20/CheckInttRawHit/build/install
export MYINSTALL2=/sphenix/user/ChengWei/SelfINTTProduction/2025_Oct_20/dNdEta_Run2023/dNdEtaINTT/build/install
export MYINSTALL3=/sphenix/user/ChengWei/SelfINTTProduction/Saturated_chip_rejection/2025_Nov_12/offline/packages/intt/build/install
...
root.exe -q -b INTTRawHit_check.C\(${process},${runnumber},${nEvents},\"${output_directory}\",\"${input_directory}\",\"${input_filename}\"\)
...
echo all done process the INTTRawHit_check.C, process_id ${process_id}
