...
int F4A_macro(
    ...
    in_calo->AddFile( Form("/sphenix/lustre01/sphnxpro/production2/run3oo/physics/calofitting/ana536_2025p010_v001/run_00082400_00082500/DST_CALOFITTING_run3oo_ana536_2025p010_v001-00082400-%s.root", job_index.c_str()) );
    in_calo->Print("ALL");
