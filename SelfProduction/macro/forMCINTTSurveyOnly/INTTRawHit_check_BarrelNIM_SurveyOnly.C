...
int INTTRawHit_check_BarrelNIM_SurveyOnly(
    int process_id = 0,
    int run_num = 82400,
    int nevents = -1,
    string output_directory = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/MC/20260215/HIJING_INTTSurveyOnly",
  
    // note : for macro
    string input_directory = "/sphenix/lustre01/sphnxpro/mdc2/shijing_hepmc/OO_0_15fm/nopileup",
    string input_filename = "I_am_cool",

    string output_file_name_suffix_in = "test_surveyonly"
){
