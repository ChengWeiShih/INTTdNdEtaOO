...
int INTTRawHit_check_BarrelNIM_CentralityTest(
    ...
    int run_num = 82391,
    int nevents = 100,
    string output_directory = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/test_82391_INTTsurveyOnly_LoacalPos_PrivateCentrality",
    ...
    std::pair<bool, std::string> PrivateCentrality = {true, "/sphenix/user/ChengWei/INTT/INTTdNdEtaOO/SelfProduction/GlauberTest/run82391/GlauberNBDfit_centrality_bounds_1pct.txt"},
    ...
    string hotchannel_full_directory_in = Form("/cvmfs/sphenix.sdcc.bnl.gov/calibrations/sphnxpro/cdb/INTT_HotMap/36/37/3637b03579bd6161cafa35f5376e91cf_intt_hotmap_cdb_82391.root"); // note : this is for the DAC Scan runs
    ...
    in_calo->Verbosity(2);
    in_calo->AddFile( Form("/sphenix/lustre01/sphnxpro/production/run3oo/physics/pro001_pcdb001_v001/DST_CALOFITTING/run_00082300_00082400/DST_CALOFITTING_run3oo_pro001_pcdb001_v001-00082391-%s.root", job_index_over10.c_str()) );
    in_calo->Print("ALL");
