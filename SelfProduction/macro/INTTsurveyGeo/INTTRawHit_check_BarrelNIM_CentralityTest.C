...
int INTTRawHit_check_BarrelNIM_CentralityTest(
    ...
    int run_num = 82391,
    int nevents = 3000,
    string output_directory = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/test_82391_INTTsurveyOnly_CentralityScaleTest",
    ...
    string output_file_name_suffix_in = "ana538",
    ...
    string bco_full_directory_in        =      "/sphenix/user/jaein213/for_playin/macro/bcomap_cdb_82391_10000_DST_1114.root";
