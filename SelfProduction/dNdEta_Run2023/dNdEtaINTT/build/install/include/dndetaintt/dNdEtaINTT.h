...
class dNdEtaINTT : public SubsysReco
{
  ...
  private:
    ...
    void GetTriggerFireInfo(PHCompositeNode *topNode);
    ...
    // Get trigger fire
    int out_MBDNS1_live_inclusive;
    int out_MBDNS1_live_vtx10cm;
    int out_MBDNS1_scaled_vtx10cm;
    int out_MBDNS1_scaled_vtx150cm;
    ...
    static const int MBDNS1_inclusive = 10; // note : MBD N&S >= 1
    static const int MBDNS1_vtx10cm   = 12; // note : MBD N&S >= 1 && vtx < 10 cm
    static const int MBDNS1_vtx150cm  = 14; // note : MBD N&S >= 1 && vtx < 150 cm
    // static const int MBDNS_tight_vtx30cm   = 13; // note : MBD N&S >= 1 && vtx < 30 cm
    // static const int MBDNS_tight_vtx60cm   = 14; // note : MBD N&S >= 1 && vtx < 60 cm
};
