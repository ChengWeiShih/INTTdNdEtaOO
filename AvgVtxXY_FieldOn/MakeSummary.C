...
int MakeSummary(
    ...
    std::string input_folder = "/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/MC/20260215/HIJING_INTTSurveyOnly_CentralityScaleTest/AvgVtxXY/completed",
    ...
    // double frame_shift_forY = -0.07 // note : cm

    double frame_shift_forX = +0.03, // note : cm
    double frame_shift_forY = -0.24 // note : cm
)
{
