...
root.exe -q -b Run_AvgVtxXY_FieldOn.C\(${process},${nfiles},${runnumber},${nEvents},\"${input_directory}\",\"${input_filename}\",\"${output_directory}\"\)


echo all done process the Run_AvgVtxXY_FieldOn.C, process_id ${process}
