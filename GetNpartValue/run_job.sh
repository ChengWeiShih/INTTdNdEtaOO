...
root.exe -q -b GetNpartValue.C\(${process},\"${MC_name}\",${nEvents},\"${input_directory}\",\"${input_filename}\",\"${output_directory}\"\)


echo all done process the GetNpartValue.C, process_id ${process}
