...
class TrackletHistogramNew : public ClusHistogram{
    ...
    protected:
        ...
        TH2D * h2D_ClusZPhi_Inner;
        TH2D * h2D_ClusZPhi_Outer;
        TH2D * h2D_ClusZPhi_Layer3;
        TH2D * h2D_ClusZPhi_Layer4;
        TH2D * h2D_ClusZPhi_Layer5;
        TH2D * h2D_ClusZPhi_Layer6;
        TH2D * h2D_ClusZPhi_All;

        TH2D * h2D_sensor_HitMap;
