...
)
{
  ...
  std::pair<bool, std::pair<double, double>> isClusQA = {true, {15,40}}; // note : {adc, phi size}

  std::string ColMulMask_map_dir = ColMulMask_map_mother_dir + "/baseline/completed/MulMap/completed";
  std::string ColMulMask_map_file = Form("MulMap_BcoFullDiffCut_Mbin70_VtxZ-30to30cm_ClusQAAdc30PhiSize%.0f_00082391.root", isClusQA.second.second);
