...
{   
    ...
    h2D_ClusZPhi_Inner = new TH2D("h2D_ClusZPhi_Inner", "h2D_ClusZPhi_Inner;ClusZ [cm];ClusPhi [radian]",100,-25,25, 100, -3.4, 3.4);
    h2D_ClusZPhi_Outer = new TH2D("h2D_ClusZPhi_Outer", "h2D_ClusZPhi_Outer;ClusZ [cm];ClusPhi [radian]",100,-25,25, 100, -3.4, 3.4);
    h2D_ClusZPhi_Layer3 = new TH2D("h2D_ClusZPhi_Layer3", "h2D_ClusZPhi_Layer3;ClusZ [cm];ClusPhi [radian]",100,-25,25, 100, -3.4, 3.4);
    h2D_ClusZPhi_Layer4 = new TH2D("h2D_ClusZPhi_Layer4", "h2D_ClusZPhi_Layer4;ClusZ [cm];ClusPhi [radian]",100,-25,25, 100, -3.4, 3.4);
    h2D_ClusZPhi_Layer5 = new TH2D("h2D_ClusZPhi_Layer5", "h2D_ClusZPhi_Layer5;ClusZ [cm];ClusPhi [radian]",100,-25,25, 100, -3.4, 3.4);
    h2D_ClusZPhi_Layer6 = new TH2D("h2D_ClusZPhi_Layer6", "h2D_ClusZPhi_Layer6;ClusZ [cm];ClusPhi [radian]",100,-25,25, 100, -3.4, 3.4);
    h2D_ClusZPhi_All = new TH2D("h2D_ClusZPhi_All", "h2D_ClusZPhi_All;ClusZ [cm];ClusPhi [radian]",100,-25,25, 100, -3.4, 3.4);

    h2D_sensor_HitMap = new TH2D("h2D_sensor_HitMap","h2D_sensor_HitMap;LayerID * 10 + sensor ZId;Ladder Phi Id",40,30,70,18,0,18);
...
void TrackletHistogramNew::MainProcess()
{
    ...
    for (int i = 0; i < run_nEvents; i++)
    {
        ...
        for (ClusHistogram::clu_info this_clu : evt_sPH_inner_nocolumn_vec){
            ...
            h2D_ClusZPhi_Inner -> Fill(this_clu.z, atan2(this_clu.y, this_clu.x), INTTvtxZWeighting);
            if (this_clu.layerID == 3){h2D_ClusZPhi_Layer3 -> Fill(this_clu.z, atan2(this_clu.y, this_clu.x), INTTvtxZWeighting);}
            if (this_clu.layerID == 4){h2D_ClusZPhi_Layer4 -> Fill(this_clu.z, atan2(this_clu.y, this_clu.x), INTTvtxZWeighting);}
            
            h2D_ClusZPhi_All -> Fill(this_clu.z, atan2(this_clu.y, this_clu.x), INTTvtxZWeighting);
            h2D_sensor_HitMap -> Fill(this_clu.layerID * 10 + this_clu.sensorZID, this_clu.ladderPhiID, INTTvtxZWeighting);
        }
        for (ClusHistogram::clu_info this_clu : evt_sPH_outer_nocolumn_vec){
            ...
            h2D_ClusZPhi_Outer -> Fill(this_clu.z, atan2(this_clu.y, this_clu.x), INTTvtxZWeighting);
            if (this_clu.layerID == 5){h2D_ClusZPhi_Layer5 -> Fill(this_clu.z, atan2(this_clu.y, this_clu.x), INTTvtxZWeighting);}
            if (this_clu.layerID == 6){h2D_ClusZPhi_Layer6 -> Fill(this_clu.z, atan2(this_clu.y, this_clu.x), INTTvtxZWeighting);}
...
void TrackletHistogramNew::EndRun()
{
    ...
    h2D_ClusZPhi_Inner -> Write();
    h2D_ClusZPhi_Outer -> Write();
    h2D_ClusZPhi_Layer3 -> Write();
    h2D_ClusZPhi_Layer4 -> Write();
    h2D_ClusZPhi_Layer5 -> Write();
    h2D_ClusZPhi_Layer6 -> Write();
    h2D_ClusZPhi_All -> Write();
    h2D_sensor_HitMap -> Write();
