...
int Run_82391_comp(int condor_index = 0)
{   
    ...
    std::string MC_input_directory = output_directory; //"/sphenix/tg/tg01/commissioning/INTT/work/cwshih/Run25/dNdEtaOO/MC/20260215/HIJING_INTTSurveyOnly_CentralityScaleTest";
    ...
    GFR -> PrepareBaseLine(
        ...
        MC_input_directory,
        "MC_TrackHist_vtxZReweight_ClusQAAdc15PhiSize40_merged.root", // note : derive the alpha correction
        "MC_TrackHist_vtxZReweight_ClusQAAdc15PhiSize40_merged.root"  // note : closure test
    );
